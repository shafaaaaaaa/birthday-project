...
const Home = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setOpacity(0); // Ubah opacity menjadi 0 setelah 9.0 detik
    }, 9000);

    const hideConfetti = setTimeout(() => {
      setShowConfetti(false); // Hapus confetti setelah 10 detik
    }, 10000);
  ...
  return (
    <div className="main-container">
      {showConfetti && (
        <div style={{ opacity: opacity, transition: "opacity 1.0s" }}>
